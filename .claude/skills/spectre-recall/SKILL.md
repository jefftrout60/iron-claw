...
decisions-health-knowledge-architecture|decisions|health_knowledge, health intelligence, Oura, blood labs, DEXA, biometric, trusted sources, Attia, Huberman, Patrick, SQLite migration|Use when touching health_knowledge.json, planning health intelligence features, or deciding whether to prune/migrate health knowledge data
